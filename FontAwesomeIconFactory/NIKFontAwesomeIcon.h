...
typedef NS_ENUM(UniChar, NIKFontAwesomeIcon) {
    ...
    NIKFontAwesomeIconPiedPiperPP = 0xf1a7,
    ...
    /*
     4.6 -> 30
     */
    NIKFontAwesomeIconGitlab = 0xf296,
    NIKFontAwesomeIconWpbeginner = 0xf297,
    NIKFontAwesomeIconWpforms = 0xf298,
    NIKFontAwesomeIconEnvira = 0xf299,
    NIKFontAwesomeIconUniversalAccess = 0xf29a,
    NIKFontAwesomeIconWheelchairAlt = 0xf29b,
    NIKFontAwesomeIconQuestionCircleO = 0xf29c,
    NIKFontAwesomeIconBlind = 0xf29d,
    NIKFontAwesomeIconAudioDescription = 0xf29e,
    NIKFontAwesomeIconVolumeControlPhone = 0xf2a0,
    NIKFontAwesomeIconBraille = 0xf2a1,
    NIKFontAwesomeIconAssistiveListeningSystems = 0xf2a2,
    NIKFontAwesomeIconAslInterpreting = 0xf2a3,
    NIKFontAwesomeIconAmericanSignLanguageInterpreting = 0xf2a3,
    NIKFontAwesomeIconDeafness = 0xf2a4,
    NIKFontAwesomeIconHardOfHearing = 0xf2a4,
    NIKFontAwesomeIconDeaf = 0xf2a4,
    NIKFontAwesomeIconGlide = 0xf2a5,
    NIKFontAwesomeIconGlideG = 0xf2a6,
    NIKFontAwesomeIconSigning = 0xf2a7,
    NIKFontAwesomeIconSignLanguage = 0xf2a7,
    NIKFontAwesomeIconLowVision = 0xf2a8,
    NIKFontAwesomeIconViadeo = 0xf2a9,
    NIKFontAwesomeIconViadeoSquare = 0xf2aa,
    NIKFontAwesomeIconSnapchat = 0xf2ab,
    NIKFontAwesomeIconSnapchatGhost = 0xf2ac,
    NIKFontAwesomeIconSnapchatSquare = 0xf2ad,
    NIKFontAwesomeIconPiedPiper = 0xf2ae,
    NIKFontAwesomeIconFirstOrder = 0xf2b0,
    NIKFontAwesomeIconYoast = 0xf2b1,
    NIKFontAwesomeIconThemeisle = 0xf2b2,
    NIKFontAwesomeIconGooglePlusCircle = 0xf2b3,
    NIKFontAwesomeIconGooglePlusOfficial = 0xf2b3,
    NIKFontAwesomeIconFa = 0xf2b4,
    NIKFontAwesomeIconFontAwesome = 0xf2b4,
    /*
     4.7 -> 41
     */
    NIKFontAwesomeIconHandshakeO = 0xf2b5,
    NIKFontAwesomeIconEnvelopeOpen = 0xf2b6,
    NIKFontAwesomeIconEnvelopeOpenO = 0xf2b7,
    NIKFontAwesomeIconLinode = 0xf2b8,
    NIKFontAwesomeIconAddressBook = 0xf2b9,
    NIKFontAwesomeIconAddressBookO = 0xf2ba,
    NIKFontAwesomeIconVcard = 0xf2bb,
    NIKFontAwesomeIconAddressCard = 0xf2bb,
    NIKFontAwesomeIconVcardO = 0xf2bc,
    NIKFontAwesomeIconAddressCardO = 0xf2bc,
    NIKFontAwesomeIconUserCircle = 0xf2bd,
    NIKFontAwesomeIconUserCircleO = 0xf2be,
    NIKFontAwesomeIconUserO = 0xf2c0,
    NIKFontAwesomeIconIDBadge = 0xf2c1,
    NIKFontAwesomeIconDriversLicense = 0xf2c2,
    NIKFontAwesomeIconIDCard = 0xf2c2,
    NIKFontAwesomeIconDriversLicenseO = 0xf2c3,
    NIKFontAwesomeIconIDCardO = 0xf2c3,
    NIKFontAwesomeIconQuora = 0xf2c4,
    NIKFontAwesomeIconFreeCodeCamp = 0xf2c5,
    NIKFontAwesomeIconTelegram = 0xf2c6,
    NIKFontAwesomeIconThermometer4 = 0xf2c7,
    NIKFontAwesomeIconThermometer = 0xf2c7,
    NIKFontAwesomeIconThermometerFull = 0xf2c7,
    NIKFontAwesomeIconThermometer3 = 0xf2c8,
    NIKFontAwesomeIconThermometerThreeQuarters = 0xf2c8,
    NIKFontAwesomeIconThermometer2 = 0xf2c9,
    NIKFontAwesomeIconThermometerHalf = 0xf2c9,
    NIKFontAwesomeIconThermometer1 = 0xf2ca,
    NIKFontAwesomeIconThermometerQuarter = 0xf2ca,
    NIKFontAwesomeIconThermometer0 = 0xf2cb,
    NIKFontAwesomeIconThermometerEmpty = 0xf2cb,
    NIKFontAwesomeIconShower = 0xf2cc,
    NIKFontAwesomeIconBathtub = 0xf2cd,
    NIKFontAwesomeIconS15 = 0xf2cd,
    NIKFontAwesomeIconBath = 0xf2cd,
    NIKFontAwesomeIconPodcast = 0xf2ce,
    NIKFontAwesomeIconWindowMaximize = 0xf2d0,
    NIKFontAwesomeIconWindowMinimize = 0xf2d1,
    NIKFontAwesomeIconWindowRestore = 0xf2d2,
    NIKFontAwesomeIconTimesRectangle = 0xf2d3,
    NIKFontAwesomeIconWindowClose = 0xf2d3,
    NIKFontAwesomeIconTimesRectangleO = 0xf2d4,
    NIKFontAwesomeIconWindowCloseO = 0xf2d4,
    NIKFontAwesomeIconBandcamp = 0xf2d5,
    NIKFontAwesomeIconGrav = 0xf2d6,
    NIKFontAwesomeIconEtsy = 0xf2d7,
    NIKFontAwesomeIconImdb = 0xf2d8,
    NIKFontAwesomeIconRavelry = 0xf2d9,
    NIKFontAwesomeIconEercast = 0xf2da,
    NIKFontAwesomeIconMicrochip = 0xf2db,
    NIKFontAwesomeIconSnowflakeO = 0xf2dc,
    NIKFontAwesomeIconSuperpowers = 0xf2dd,
    NIKFontAwesomeIconWpexplorer = 0xf2de,
    NIKFontAwesomeIconMeetup = 0xf2e0
};
